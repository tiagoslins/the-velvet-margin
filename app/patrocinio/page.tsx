  ...
  const opportunities = [
    {
      ...
      image: "/images/patrocinio/narrativa-autentica.webp.png",
    ...
    },
    {
      ...
      image: "/images/patrocinio/impacto-cultural.webp.png",
    ...
    },
    {
      ...
      image: "/images/patrocinio/ecossistema-conteudo.webp.png",
    ...
    },
    {
      ...
      image: "/images/patrocinio/valor-institucional.webp.png",
  ...
  return <main className="inner-page sponsorship-page">
    ...
    <section className="brand-opportunity">
      ...
      <div className="opportunity-grid opportunity-image-grid">
        ...
        >
          <div className="opportunity-card-image"><img src={item.image} alt={item.alt} /></div>
    ...
    {selectedOpportunity && <div className="opportunity-modal-backdrop" role="presentation" onClick={() => setActiveOpportunity(null)}>
      <section className="opportunity-modal" role="dialog" aria-modal="true" aria-labelledby="opportunity-modal-title" onClick={(event) => event.stopPropagation()}>
        <button className="opportunity-modal-close" type="button" onClick={() => setActiveOpportunity(null)} aria-label={pt ? "Fechar janela" : "Close dialog"}>×</button>
        <div className="opportunity-modal-image"><img src={selectedOpportunity.image} alt={selectedOpportunity.alt} /></div>
