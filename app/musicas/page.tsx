...
function MusicContent() { const { language } = useSiteLanguage(); const pt = language === "pt"; return <main className="inner-page">
  <section className="music-photo-hero"><img src="/members/diego-aquino.png" alt="Diego Aquino tocando contrabaixo" /><div><p className="kicker">{pt ? "MÚSICAS" : "MUSIC"}</p><h1>{pt ? "As primeiras margens sonoras." : "The first sonic margins."}</h1></div></section>
